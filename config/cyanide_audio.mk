#
# CyanideL Audio Files
#

ALARM_PATH := vendor/cyanide/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/cyanide/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/cyanide/prebuilt/common/media/audio/ringtones
UI_PATH := vendor/cyanide/prebuilt/common/media/audio/ui
